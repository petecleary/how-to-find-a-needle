...
public sealed class AnswerValidatorTests
{
    ...
    public void Validate_GroundedAnswerThatWarnsAboutTheNearMiss_HasNoWarnings()
    {
        ...
        var validation = AnswerValidator.Validate(answer, Gq03Evidence());
    ...
    {
        var validation = AnswerValidator.Validate("Try the Voltline 90W [PROD-0099].", Gq03Evidence());
    ...
    {
        var validation = AnswerValidator.Validate("Any 65W USB-C charger will work.", Gq03Evidence());
    ...
    {
        // Real qwen3.6:35b output for GQ-03 (2026-09-15): the bullets only state reasons, but the list is introduced as warnings.
        const string answer = """
    ...
    public void Validate_SentenceCitingIncompatibleProduct_WarnsOnlyWithoutWarningLanguage(string answer, bool expectWarning)
    {
        ...
        var validation = AnswerValidator.Validate("[PROD-0012] fits. " + answer, Gq03Evidence());
