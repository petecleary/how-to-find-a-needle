...
public sealed class PedagogyStageGoldenQueryTests(AppHostFixture fixture)
{
    ...
    [Fact]
    public async Task GQ03_Pedagogy_ExplainsTheCompatibleChargerWithTheNearMissAsCounterExample()
    {
    ...
    [Fact]
    public async Task GQ03_Pedagogy_BaselineHasNoStructureAndNoCitationWarnings()
    {
    ...
    {
        var request = GoldenQueryCase.Load("GQ-03").Request.DeepClone().AsObject();
