...
{
    [Fact]
    public async Task GQ03_Hybrid_StillRanksTheIncompatibleChargerHighly()
    {
        ...
        var response = await GoldenQueryRunner.RunAsync(fixture, "GQ-03", "hybrid");
    ...
    [Fact]
    public async Task GQ04_Hybrid_PutsTheDrillBatteryAboveTheKeywordTrap()
    {
        ...
        await GoldenQueryRunner.RunAsync(fixture, "GQ-04", "hybrid");
    }
}
