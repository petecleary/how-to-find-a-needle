...
src/
  ...
  PI.SearchApi/
    ...
    Embeddings/                  # ONNX embedder (ADR-0009)
    Pipeline/                    # one folder per technique service (ADR-0004)
      Structured/ Keyword/ Vector/ Fusion/ Ontology/ Rag/ Pedagogy/
    Endpoints/
