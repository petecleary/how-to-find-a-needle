...
7. **Results tab** (0014, 0003, 0013)
   ...
   - Findings:
     ...
     - ❓ **The chargers show a laptop icon.** The TTL gives `laptop-chargers` the icon `laptop`, and a row uses its first category's icon (ADR-0014). Suggest `plug` in the TTL, a data change; not made.
     - ❓ **Density at 1280×720 with the filter sidebar open:** Stage 5's two columns wrap long names, and the flagged column shows about 2½ cards. Talk mode (drawer, presentation mode) will have the full width; decide whether the demo should start with the sidebar closed.
